...
import { login as loginApi, getGoogleAuthUrl, getGithubAuthUrl } from '@/lib/api';
    ...
    <main className="min-h-screen flex items-center justify-center p-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold">QoldAI - IT Fest 2025</h1>
        ...
        <div className="grid grid-cols-1 gap-4">
          <a
            ...
            className="flex items-center justify-center gap-2 py-3 px-4 rounded-lg border border-border hover:bg-muted transition-colors"
          >
